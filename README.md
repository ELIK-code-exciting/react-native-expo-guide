...
Для добавления навигации и других функций нужно устанавливать пакеты через npx expo install.
...
💡 Используй npx expo install, а не npm install — это гарантирует совместимость версий с Expo. 
